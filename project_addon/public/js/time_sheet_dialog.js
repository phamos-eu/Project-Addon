frappe.provide('erpnext.project_addon');
erpnext.project_addon.MakeTimeSheetDialog = class MakeTimeSheetDialog {
	constructor(opts) {
		$.extend(this, opts);
		this.setup(opts.doc);
	}
	...
	make_timesheet() {
        ...
        frappe.call({
            method: "project_addon.events.project.make_timesheet",
            args: {
                doc: me.values
            },
            callback: function (r) {
